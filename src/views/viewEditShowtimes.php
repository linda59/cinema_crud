<?php $this->titre = "Gestion des cinémas - Ajouter une séance"; ?>
...
<?php if ($fromCinema): ?>
    ...
    -->
    <form name="cinemaShowtimes" method="GET" action="index.php"> 
...
<?php else: ?>
    ...
    -->
    <form name="movieShowtimes" method="GET" action="index.php"> 
