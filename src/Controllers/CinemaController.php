        ...
        if (filter_input(INPUT_SERVER, 'REQUEST_METHOD') === "POST") {
            ...
            // sinon (l'action demandée est la sauvegarde d'un cinéma)
                ...
                if ($sanEntries['modificationInProgress'] == NULL) {
                    ...
                    $this->cinemaDAO->insertNewCinema($sanEntries['denomination'], $sanEntries['adresse']);
                }
                // sinon, nous sommes dans le cas d'une modification
                    ...
                    $this->cinemaDAO->updateCinema($sanEntries['cinemaID'], $sanEntries['denomination'], $sanEntries['adresse']);
                }
