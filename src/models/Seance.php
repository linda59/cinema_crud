...
class Seance extends Model{
    ...
    //public abstract function insertNewCinema($denomination, $adresse);

    //public abstract function updateCinema($cinemaID, $denomination, $adresse);
    
    //public abstract function deleteCinema($cinemaID);
    
     //public abstract function getCinemasList();
     
     //public abstract function getCinemaInformationsByID($cinemaID);
